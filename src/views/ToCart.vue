    ...
    <div class="container">
      <div class="row">
        ...
        <table class="table table-hover table-bordered">
          <thead>
            <tr>
              <th>
                <div id="select-all">
                  <span @click="selectAll" :class="['select', selectedAll?'selected':'']"></span>
                </div>
              </th>
          ...
          <tbody>
            <tr v-for="(item) in goodList" :key="item.id">
              <td>
                <span @click="select(item)" :class="['select', item.checked?'selected':'']"></span>
              </td>
              <td>
        ...
        <div class="price-sum">
          <p class="goods-sum">
            已选择
            <span>{{goodsSum}}</span> 件商品
          </p>
          <p class="goods-price">
            总价：
            <span>￥{{formatPrice(goodsPriceTotal)}}</span>
          </p>
