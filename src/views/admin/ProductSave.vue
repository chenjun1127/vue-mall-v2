    ...
    <div class="container">
      ...
      <form class="form-horizontal">
        <div class="form-group">
          ...
          <div class="col-md-10">
            <input type="text" class="form-control" id="productName" @blur="validate($event)" v-model="productInfo.name" placeholder="商品名称" />
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-md-10">
              <select v-model="selected" class="form-control" @blur="validate($event)">
                <option v-for="option in categories" :key="option.id" v-bind:value="option.id">{{ option.name }}</option>
              </select>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-md-10">
              <p class="form-control-static">
                没找到合适的分类？去
                <router-link :to="{path:'/category/add'}">添加分类</router-link>吧！
              </p>
            </div>
          </div>
        </div>
        ...
        <div v-else class="form-group">
          ...
          <div class="col-md-10">
            <p class="form-control-static">
              当前暂无分类，请先
              <a href="javascript:void(0)" @click="addCategory">添加分类</a>
            </p>
          </div>
        </div>
        <div class="form-group">
